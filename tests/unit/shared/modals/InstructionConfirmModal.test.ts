...
function clickButton(root: any, text: string): void {
  const buttons = findAllByClass(root, 'sidebar-mimocode-instruction-btn');
...
describe('InstructionModal', () => {
  describe('onOpen', () => {
    it('renders the raw instruction text', () => {
      ...
      const originalEl = findByClass(contentEl, 'sidebar-mimocode-instruction-original');
    ...
    it('starts in loading state', () => {
      ...
      const loadingEl = findByClass(contentEl, 'sidebar-mimocode-instruction-loading');
      expect(loadingEl).not.toBeNull();
      expect(loadingEl.hasClass('sidebar-mimocode-hidden')).toBe(false);

      const clarificationEl = findByClass(contentEl, 'sidebar-mimocode-instruction-clarification-section');
      expect(clarificationEl.hasClass('sidebar-mimocode-hidden')).toBe(true);

      const confirmationEl = findByClass(contentEl, 'sidebar-mimocode-instruction-confirmation-section');
      expect(confirmationEl.hasClass('sidebar-mimocode-hidden')).toBe(true);
    });
    ...
    it('renders Cancel button in loading state', () => {
      ...
      const buttons = findAllByClass(contentEl, 'sidebar-mimocode-instruction-btn');
  ...
  describe('showClarification', () => {
    it('transitions to clarification state', () => {
      ...
      const loadingEl = findByClass(contentEl, 'sidebar-mimocode-instruction-loading');
      expect(loadingEl.hasClass('sidebar-mimocode-hidden')).toBe(true);

      const clarificationEl = findByClass(contentEl, 'sidebar-mimocode-instruction-clarification-section');
      expect(clarificationEl.hasClass('sidebar-mimocode-hidden')).toBe(false);
    });
    ...
    it('displays the clarification text', () => {
      ...
      const clarificationTextEl = findByClass(contentEl, 'sidebar-mimocode-instruction-clarification');
  ...
  describe('showConfirmation', () => {
    it('transitions to confirmation state', () => {
      ...
      const confirmationEl = findByClass(contentEl, 'sidebar-mimocode-instruction-confirmation-section');
      expect(confirmationEl.hasClass('sidebar-mimocode-hidden')).toBe(false);
    });
    ...
    it('displays the refined instruction', () => {
      ...
      const refinedEl = findByClass(contentEl, 'sidebar-mimocode-instruction-refined');
