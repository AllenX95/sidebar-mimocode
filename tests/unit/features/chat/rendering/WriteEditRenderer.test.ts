...
describe('WriteEditRenderer', () => {
  describe('createWriteEditBlock', () => {
    ...
    it('should start collapsed by default', () => {
      ...
      expect(state.contentEl.hasClass('sidebar-mimocode-hidden')).toBe(true);
    ...
    it('should start expanded when requested', () => {
      ...
      expect(state.contentEl.hasClass('sidebar-mimocode-hidden')).toBe(false);
  ...
  describe('renderStoredWriteEdit', () => {
    ...
    it('should start collapsed by default', () => {
      ...
      const block = renderStoredWriteEdit(parentEl, toolCall);
      const headerEl = block.querySelector('.sidebar-mimocode-write-edit-header');
      const contentEl = block.querySelector('.sidebar-mimocode-write-edit-content');

      expect(block.hasClass('expanded')).toBe(false);
      expect(contentEl?.hasClass('sidebar-mimocode-hidden')).toBe(true);
