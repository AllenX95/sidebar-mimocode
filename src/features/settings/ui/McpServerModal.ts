...
export class McpServerModal extends Modal {
  ...
  onOpen() {
    ...
    this.modalEl.addClass('sidebar-mimocode-mcp-modal');
    ...
    this.typeFieldsEl = contentEl.createDiv({ cls: 'sidebar-mimocode-mcp-type-fields' });
    this.renderTypeFields();
    ...
    const buttonContainer = contentEl.createDiv({ cls: 'sidebar-mimocode-mcp-buttons' });
    ...
    const saveBtn = buttonContainer.createEl('button', {
      ...
      cls: 'sidebar-mimocode-save-btn mod-cta',
    });
  ...
  private renderStdioFields() {
    ...
    cmdSetting.settingEl.addClass('sidebar-mimocode-mcp-cmd-setting');

    const cmdTextarea = cmdSetting.controlEl.createEl('textarea', {
      cls: 'sidebar-mimocode-mcp-cmd-textarea',
    });
    ...
    envSetting.settingEl.addClass('sidebar-mimocode-mcp-env-setting');

    const envTextarea = envSetting.controlEl.createEl('textarea', {
      cls: 'sidebar-mimocode-mcp-env-textarea',
    });
  ...
  private renderUrlFields() {
    ...
    headersSetting.settingEl.addClass('sidebar-mimocode-mcp-env-setting');
