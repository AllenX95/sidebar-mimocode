...
type MimoKnownToolName = keyof typeof TOOL_NAME_MAP;

function isPlainObject(value: unknown): value is Record<string, unknown> {
  return value !== null && typeof value === 'object' && !Array.isArray(value);
}

function isKnownToolName(value: unknown): value is MimoKnownToolName {
...
function toKnownToolName(value: string | undefined): MimoKnownToolName | null {
  if (!value) {
    return null;
  }
...
export function resolveMimoRawToolName(
...
export function normalizeMimoToolName(rawName: string | undefined): string {
...
export function normalizeMimoToolInput(
...
export function normalizeMimoToolUseResult(
  rawName: string | undefined,
  input: Record<string, unknown>,
  rawOutput: unknown,
...
export function createMimoToolStreamAdapter(): AcpToolStreamAdapter {
  return new AcpToolStreamAdapter({
    normalizeToolInput: normalizeMimoToolInput,
    normalizeToolName: normalizeMimoToolName,
    normalizeToolUseResult: normalizeMimoToolUseResult,
    resolveRawToolName: resolveMimoRawToolName,
  });
}
