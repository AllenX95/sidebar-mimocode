 ...
 * all providers: SidebarMimocode settings, tab manager state, and session metadata.
 *
...
export interface SharedAppStorage {
  initialize(): Promise<{ sidebarMimocode: Record<string, unknown> }>;
  saveSidebarMimocodeSettings(settings: Record<string, unknown>): Promise<void>;
